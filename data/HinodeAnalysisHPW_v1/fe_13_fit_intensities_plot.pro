...
pro fe_13_fit_intensities_plot, ps=ps
  ...
  files = ['fe_13_fit_intensities.30.h5', $
           'fe_13_fit_intensities.15.h5', $
           'fe_13_fit_intensities.10.h5', $
           'fe_13_fit_intensities.05.h5']

  files = file_search('fe_13_fit_intensities.*.h5')
  results = list()
