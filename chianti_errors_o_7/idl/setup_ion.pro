...
;       v.13, added keyword uncertainty
;
; VERSION     :   13
;
;-
...
PRO setup_ion,ions,wvlmin,wvlmax,wvltst,lvl1,lvl2,wvl1,gf1,a_value1, $
              ...
              default_uncertainty=default_uncertainty, normal=normal, uncertainty=uncertainty
...
; check if the uncertainty is present, otherwise use the  default
      ...
      for ii=0L,nnl-1 do $
          a_value1[ii]=a_value1[ii]*((1. + uncertainty/100.*rnd[ii]) > 0.01) 
